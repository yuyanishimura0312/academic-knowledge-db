#!/usr/bin/env python3
"""Import Phase 7 poetics expansion (12 Codex workers) into academic.db."""

import json, sqlite3, uuid
from pathlib import Path

DB_PATH = Path(__file__).parent / "academic.db"
COLLECT_DIR = Path("/tmp/poetics_collect_p7")
FILES = sorted(f.name for f in COLLECT_DIR.glob("P7_*.json"))
