...
CONCEPTS = [
    ...
    ("Inkle Heaven's Vault古代言語", "Inkle Heaven's Vault ancient lang", "西欧",
     "Inkle Studios2019年作品。古代言語解読を核としたゲーム文学、考古学的読解の新形式。"),
    ("Florenceゲーム形式短編", "Florence game short story", "西欧",
     "Mountains開発2018年作品。台詞なしジェスチャー操作で恋愛を語るゲーム形式の短編文学。"),
    ("Disco Elysium文学性詳細", "Disco Elysium literary detail", "東欧",
     "ZA/UM 2019年作品。100万語超のテクスト量と内的独白を備えるRPG形式の哲学小説。"),
    ("Citizen Sleeper TRPG文学", "Citizen Sleeper TRPG literature", "西欧",
