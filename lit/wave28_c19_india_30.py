...
CONCEPTS = [
    ...
    ("バーラヴィ『キラータールジュニーヤ』十八歌", "Bharavi Kiratarjuniya 18 cantos", "किरातार्जुनीयम्", "sanskrit", P_CLASSIC_KAVYA, "アルジュナとシヴァの戦闘叙事詩。十八歌、五大マハーカーヴィヤの一つで重厚な文体を確立。"),
    ("マーガ『シシュパーラヴァダ』二十歌", "Magha Sisupalavadha 20 cantos", "शिशुपालवध", "sanskrit", P_CLASSIC_KAVYA, "シシュパーラ討伐譚。二十歌、技巧と語彙の壮麗さで「マーガに知らぬ語なし」と称される。"),
    ("シュリーハルシャ『ナイシャダチャリタ』二十二歌", "Sriharsha Naisadhacarita 22 cantos", "नैषधचरितम्", "sanskrit", P_CLASSIC_KAVYA, "ナラ王譚。二十二歌、哲学的議論と難解な語法で後期マハーカーヴィヤの完成形。"),
    ("アーナンダヴァルダナ『ドヴァニャーローカ』四章", "Anandavardhana Dhvanyaloka 4 udyota", "ध्वन्यालोकः", "sanskrit", P_CLASSIC_KAVYA, "暗示の光。九世紀カシミール、詩の本質を暗示(dhvani)に置く理論で詩学を革新。"),
    ("マンマタ『カーヴィヤプラカーシャ』十章", "Mammata Kavyaprakasha 10 ullasa", "काव्यप्रकाश", "sanskrit", P_CLASSIC_KAVYA, "詩の光。十一世紀の標準的詩学概論、十章構成でラサ・ドヴァニ・修辞を統合。"),
    ("ヴィシュヴァナータ『サーヒティヤダルパナ』十章", "Visvanatha Sahityadarpana 10 pariccheda", "साहित्यदर्पण", "sanskrit", P_CLASSIC_KAVYA, "文学の鏡。十四世紀、ラサを詩の魂と定め十章でジャンル論まで包括する詩学綱要。"),
    # Cluster 3: Tamil詳細 (6)
    ...
    ("マニメーガライ三十カーンディ", "Manimekalai 30 cantos", "மணிமேகலை", "tamil", P_TAMIL_MED, "サッタナール作タミル仏教叙事詩。三十カーンディ、シラッパディカーラムの続編で改宗譚。"),
    ("ティルックラル・三部構成", "Tirukkural three sections", "திருக்குறள்", "tamil", P_SANGAM, "ティルヴァッルヴァル作。アラム(徳)・ポルル(財)・インバム(愛)三部、各クラル二行で1330句。"),
    ("ペリヤ・プラーナム六十三聖者列伝", "Periya Puranam 63 nayanars", "பெரிய புராணம்", "tamil", P_TAMIL_MED, "セーッキラール作。六十三ナーヤナール聖者列伝、シャイヴァ・シッダーンタ正典の十二典籍。"),
    ("テーヴァーラム七巻", "Tevaram 7 books", "தேவாரம்", "tamil", P_TAMIL_MED, "サンバンダル・アッパル・スンダラル三聖者によるシヴァ讃歌集、シャイヴァ十二典籍冒頭七巻。"),
    ...
    ("タゴール『ゴーラ』1910", "Tagore Gora (1910)", "গোরা", "bengali", P_BENGAL, "1910年。アイルランド系孤児ゴーラのアイデンティティを通じインド近代の宗教・国民論を描く長編。"),
    ...
    ("キラン・デサイ『喪失の継承』2006", "Kiran Desai Inheritance of Loss (2006)", "The Inheritance of Loss", "latin", P_INDOENG, "2006年ブッカー賞。カリンポンの退職判事と移民料理人の息子、グローバリゼーションの陰影。"),
