...
concepts = [
    ...
    ("ブリューソフ『火の天使』", "Bryusov Fiery Angel", "Огненный ангел", "cyrillic", P_SILVER, R_RUS,
    ...
    ("アンネンスキー『糸杉の小箱』", "Annensky Cypress Casket", "Кипарисовый ларец", "cyrillic", P_SILVER, R_RUS,
     "1910年遺作詩集。透明な憂愁と細密な感覚で銀の時代詩学を結晶化した。", 4, "invariant", "tier1", "yes"),
    ("ヴャチェスラフ・イワノフ『コル・アルデンス』", "Vyacheslav Ivanov Cor Ardens", "Cor Ardens", "latin", P_SILVER, R_RUS,
     "1911年の二部構成詩集。神秘主義と古典神話を織り合わせた象徴主義の理論的中核。", 4, "invariant", "tier1", "yes"),
    ("メレジコフスキー『キリストと反キリスト』三部作", "Merezhkovsky Christ and Antichrist", "Христос и Антихрист", "cyrillic", P_SILVER, R_RUS,
    ...
    ("マンデリシュタム『石』", "Mandelstam Stone", "Камень", "cyrillic", P_SILVER, R_RUS,
    ...
    ("グミリョフ『火の柱』", "Gumilyov Pillar of Fire", "Огненный столп", "cyrillic", P_SILVER, R_RUS,
    ...
    ("ミツキェヴィチ『パン・タデウシュ』", "Mickiewicz Pan Tadeusz", "Pan Tadeusz", "latin", P_POLAND, R_RUS,
     "1834年のポーランド民族叙事詩。リトアニア貴族社会の郷愁を描いた国民的古典。", 5, "invariant", "tier1", "yes"),
    ("シュルツ『シナモン書房』", "Schulz Cinnamon Shops", "Sklepy cynamonowe", "latin", P_POLAND, R_RUS,
