...
CONCEPTS = [
    ...
    ("義経記","Gikeiki","義經記","kanji",P_CHUSEI,
     "室町期成立の源義経一代記8巻。判官贔屓の系譜を形成し能・歌舞伎の源泉。",4),
    ...
    ("宇治拾遺物語","Uji Shui Monogatari","宇治拾遺物語","kanji",P_CHUSEI,
     "13世紀前半成立の説話集197話15巻。仏教説話と世俗譚を等量に配した中世説話の代表。",5),
    ("古今著聞集","Kokon Chomonju","古今著聞集","kanji",P_CHUSEI,
     "1254年橘成季編の世俗説話集30篇726話。神祇・釈教・政道など分類体系で類書化。",4),
    ("沙石集","Shasekishu","沙石集","kanji",P_CHUSEI,
     "1283年無住道暁編の仏教説話集10巻。和漢混淆体で禅宗的世俗化を進めた説話論。",5),
    ("三国伝記","Sangoku Denki","三國傳記","kanji",P_CHUSEI,
     "玄棟編1407-46年頃の説話集12巻360話。天竺・震旦・本朝三国構成の中世末説話集成。",3),
